...
import styles from "../styles/biscuit.module.scss";
const Biscuit: NextPage = () => {
  return (
    <div>
      <Head>
        <title>Andressa Sakamoto Biscuit - Biscuit</title>
        <meta
          name="description"
          content="Descrição do material utilizado para confecção dos produtos."
        />
        <meta
          name="keywords"
          content="biscuit, descrição, material, artesanato"
        />
      </Head>
      <NavBar biscuit={true} />
